...
class TapClubCardScreen extends StatefulWidget {
  const TapClubCardScreen({Key? key}) : super(key: key);

  @override
  _TapClubCardScreenState createState() => _TapClubCardScreenState();
}

class _TapClubCardScreenState extends State<TapClubCardScreen> {
  @override
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RichText(
                          ...
                          text: TextSpan(
                            text: LocaleTexts.askTapCard1.tr(),
                            style: TextStyle(
                            ...
                            children: <TextSpan>[
                              ...
                              TextSpan(
                                  text: LocaleTexts.askTapCard2.tr(),
                                  style: TextStyle(
                                      color: AppColors.black,
                                      fontSize: subTitleTextSize)),
                            ],
