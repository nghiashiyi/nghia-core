                                ...
                                Expanded(
                                  child: Row(
                                    children: [
                                                            ...
                                                            child: Row(
                                                              children: [
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      '${exampleProduct.productName} - ${exampleProduct.productWeight}kg',
                                                                      style: TextStyle(
                                                                          fontSize:
                                                                              subTitleTextSize,
                                                                          fontWeight:
                                      ...
                                      Text(
                                        'x ${exampleProduct.productPrice.toString()}',
                                        style: TextStyle(
                                            fontWeight: FontWeight.w500),
                                      ),
                                    ],
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    AppIcons.delete_icon
                                                        .widget(height: 70),
                                                    Text(
                                                      '${exampleProduct.productName} - ${exampleProduct.productWeight}${LocaleTexts.kg.tr()}',
                                                      style: TextStyle(
                                                          fontSize: 16,
                                                          fontWeight:
                                                              FontWeight.w500,
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          padding:
                              EdgeInsets.symmetric(horizontal: paddingCont),
                          margin: EdgeInsets.symmetric(horizontal: paddingCont),
                          decoration: BoxDecoration(
                              color: AppColors.mainBlue,
